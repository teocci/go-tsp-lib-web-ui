...
const CENTER = {x: 126.981353, y: 37.563034}
...
const RANDOM_MODE = RANDOM_MODE_PROD

const FETCH_MODE_PROD = 'prod'
const FETCH_MODE_TEST = 'test'
const FETCH_MODE = FETCH_MODE_PROD
...
const FILE_LOAD_MAX_CNT = 50

const MAP_BOUNDARY = {
    swX: 126.57298757791372,
    swY: 37.37043682980272,
    neX: 127.39144157411216,
    neY: 37.753733424630596,
    isContained(point) {
